	...
	<body class="no-sidebar is-preload">
			...
			<!-- Main -->
				<section id="main">
					<div class="container">
						...
						<br><br>
        <b><font size="6" color="gray">회원관리</font></b>
        <br><br><br>
        ...
        <form action="JoinService" method="post">
            ...
            <input type="submit" value="가입" id="pass" />  <input type="reset" value="취소" style="margin-left: 30px;">
                  ...
                  <tbody>
                  <%
                  	//project_member테이블에서 전체회원 정보를 검색하여 출력하시오
                  	//사용자가 입력한 정보없이 전체테이블의 정보를 검색하면 되므로 Servelet이 필요없음
                  	
                  	ProjectDAO dao = new ProjectDAO();
                 	ArrayList<ProjectVO> list= dao.memberSelect();
                  	
                 	for(int i=0; i<list.size(); i++){
			        	out.print("<tr><td>"+list.get(i).getId()+"</td>");
			        	out.print("<td>"+list.get(i).getName()+"</td>");
			        	out.print("<td>"+list.get(i).getGender()+"</td>");
			        	out.print("<td>"+list.get(i).getBirth()+"</td>");
			        	...
			        	out.print("<td>"+list.get(i).getDate()+"</td>");
			         	out.print("<td><a href='manage.jsp'?id="+list.get(i).getId()+"'>수정</a></td></tr>"); 
                 	}
