		...
		<section id="main">
			<div class="container">
				...
				<article class="box post">
					...
					%>
					<script type="text/javascript">
						alert("일시적으로 오류가 발생하였습니다 처음부터 다시 실행해주시길 바랍니다");
					...
					%>
					<img src="<%=path%>" alt="Trash Picture" id="trash" style="width: 400px; height : 400px;"/></a>
					...
					<section>
						...
						<a href="PlusService" id="plus" name="plus" class="button large">포인트
							적립</a>
						<%
							}
						}
